  ...
  const features = [
    {
      ...
      description:
        "Our advanced AI analyzes symptoms with 95% accuracy, providing instant preliminary assessments.",
    ...
    },
    {
      ...
      description:
        "Board-certified doctors with an average of 10+ years experience across all medical specialties.",
      benefits: [
    ...
    },
    {
      ...
      description:
        "Connect with specialists via video consultation from anywhere, reducing wait times by 80%.",
      benefits: [
        "Video Consultations",
        "No Travel Needed",
        "80% Less Wait Time",
    ...
    },
    {
      ...
      description:
        "Access to cutting-edge diagnostic tools and lab tests with same-day results in most cases.",
    ...
    },
    {
      ...
      description:
        "Bank-level encryption ensures your medical data remains completely confidential and secure.",
    ...
    },
    {
      ...
      description:
        "Get digital prescriptions instantly delivered to your phone and local pharmacies.",
      benefits: [
        "Digital Delivery",
  ...
  return (
    <>
      <div className="container mx-auto px-4 sm:px-6 lg:px-8">
        {/* Hero Section */}
        <div
          className={`text-center mb-12 md:mb-16 lg:mb-20 transition-all duration-1000 ${isVisible ? "opacity-100 translate-y-0" : "opacity-0 translate-y-10"}`}
        >
          ...
          <p className="text-base sm:text-lg md:text-xl text-gray-600 max-w-3xl lg:max-w-4xl mx-auto leading-relaxed px-4">
            We're transforming healthcare through AI-powered technology,
            comprehensive medical services, and a patient-centered approach that
            puts your wellness first.
          </p>
        </div>
        ...
        <div className="grid lg:grid-cols-2 gap-8 md:gap-12 lg:gap-16 mb-16 md:mb-20 lg:mb-24 items-center">
          ...
          <div
            className={`order-1 lg:order-2 transition-all duration-1000 delay-300 ${isVisible ? "opacity-100 translate-x-0" : "opacity-0 translate-x-10"}`}
          >
            <h2 className="text-2xl sm:text-3xl md:text-4xl font-bold text-gray-900 mb-4 md:mb-6">
              Our Journey
            </h2>
            <p className="text-gray-600 mb-4 md:mb-6 leading-relaxed text-base md:text-lg">
              Founded in 2020 with a vision to make quality healthcare
              accessible to everyone, HealthCarePlus has grown from a small
              startup to a comprehensive healthcare platform serving thousands
            ...
            <p className="text-gray-600 mb-6 md:mb-8 leading-relaxed text-base md:text-lg">
              ...
              challenges of accessing timely medical care. Today, we combine
              cutting-edge AI technology with human expertise to deliver
              personalized, efficient, and affordable healthcare solutions.
            </p>
            ...
            <Link
              to="/services"
              className="inline-flex items-center justify-center bg-gradient-to-r from-blue-600 to-blue-700 text-white px-6 py-3 rounded-xl hover:from-blue-700 hover:to-blue-800 transition-all duration-300 transform hover:-translate-y-1 hover:shadow-lg w-full sm:w-auto"
            >
          ...
          <div className="max-w-4xl mx-auto">
            {activeTab === "mission" && (
              <div className="text-center animate-fade-in">
                ...
                <p className="text-gray-600 text-base md:text-lg leading-relaxed">
                  To democratize healthcare by leveraging artificial
                  intelligence and technology to provide accessible, affordable,
                  and personalized medical care for everyone, regardless of
            ...
            {activeTab === "vision" && (
              <div className="text-center animate-fade-in">
                ...
                <p className="text-gray-600 text-base md:text-lg leading-relaxed">
                  To become the world's most trusted AI-powered healthcare
                  platform, creating a future where quality medical care is
                  instantly available to every person, everywhere, at any time.
                </p>
              </div>
            )}
              ...
              <div className="animate-fade-in">
                ...
                <div className="grid sm:grid-cols-2 gap-4 md:gap-6">
                  {[
                    {
                      title: "Patient First",
                      desc: "Every decision prioritizes patient welfare and experience",
                      icon: <Heart className="w-5 h-5" />,
                    },
                    {
                      title: "Innovation",
                      desc: "Continuously advancing healthcare through technology",
                      icon: <Sparkles className="w-5 h-5" />,
                    },
                    {
                      title: "Integrity",
                      desc: "Transparent, honest, and ethical in all our practices",
                      icon: <Shield className="w-5 h-5" />,
                    },
                    {
                      title: "Accessibility",
                      desc: "Making quality healthcare available to everyone",
                      icon: <Globe className="w-5 h-5" />,
                    },
                    {
                      title: "Excellence",
                      desc: "Setting highest standards in medical care",
                      icon: <Star className="w-5 h-5" />,
                    },
                    {
                      title: "Compassion",
                      desc: "Treating every patient with empathy and care",
                      icon: <Heart className="w-5 h-5" />,
                    },
                  ].map((value, index) => (
                    <div
        ...
        <div className="mb-16 md:mb-20 lg:mb-24">
          <div className="text-center mb-8 md:mb-12">
            ...
            <p className="text-gray-600 max-w-2xl mx-auto">
              Experience healthcare that's smarter, faster, and more
        ...
        <div className="mb-16 md:mb-20 lg:mb-24">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6 md:gap-8">
            {teamMembers.map((member, index) => (
              ...
              >
                <div
                  className={`bg-white border border-gray-200 rounded-2xl p-6 text-center transition-all duration-300 ${
                ...
                >
                  ...
                  {/* Desktop hover info */}
                  <div
                    className={`hidden lg:block absolute inset-0 bg-gradient-to-b from-blue-600/95 to-blue-700/95 rounded-2xl p-6 text-white opacity-0 group-hover:opacity-100 transition-all duration-300 transform translate-y-0 group-hover:translate-y-0 ${
                      hoveredTeamMember === index
                        ? "translate-y-0"
                        : "translate-y-4"
                    }`}
        ...
        <div className="bg-gradient-to-br from-blue-50 to-blue-100 rounded-3xl p-6 md:p-8 lg:p-12">
          <div className="text-center mb-8 md:mb-12">
            ...
            <p className="text-gray-600 max-w-2xl mx-auto">
              Trusted by thousands, recognized for excellence
            </p>
          </div>
